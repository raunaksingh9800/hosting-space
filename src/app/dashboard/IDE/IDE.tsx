...
import { Cloud, ChevronDown, ExternalLink, Check, Globe } from "lucide-react";
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <div className="flex flex-col md:flex-row gap-6 rounded">
        ...
        <div className="flex-1 shadow-sm">
          <div className="bg-black/10 rounded dark:bg-white/10 text-xs px-3 py-1 font-mono border-b border-black/20 dark:border-white/20">
            html
          </div>
          <Editor
            height="95vh"
        ...
        {/* Preview */}
        <div className="flex-1 rounded bg-white/5 shadow-sm">
          <iframe
            key={iframeKey}
            title="preview"
            srcDoc={code}
